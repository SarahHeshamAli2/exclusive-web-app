...
<div id="dropdown" class=   {isProfile ? "top-11 z-10  bg-[#00000062] divide-gray-100 rounded-lg absolute right-6 shadow w-44 dark:bg-gray-700" : "z-10 hidden bg-[#00000062] divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"  }>
    ...
    <button onClick={handleOpenMainMenu} type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
...
{token ?     <li className="  my-8 ">
       ...
       Log out
               ...
               <li className="  my-8 ">
                ...
                {
                  localStorage.getItem('loggedOut') ? <NavLink onClick={()=>{setMainMenu(false)}} to='/login'>Sign in</NavLink> :  <NavLink to='/register'>
                  Sign Up
             </NavLink>  
                }
                            </li> }
